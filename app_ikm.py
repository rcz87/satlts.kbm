...
def ikm_hasil_route():
    try:
        ...
        logger.error(f"IKM hasil error: {str(e)}")
        content = Markup('<div class="error-message"><h2>Terjadi Kesalahan</h2><p>Tidak dapat memuat data. Silakan coba lagi.</p><a href="/ikm">Kembali ke Survei</a></div>')
        return render_template('index.html', content=content, current_page='ikm')
